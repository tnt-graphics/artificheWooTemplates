...
<main id="primary" class="site-main">
	...
	<?php
		...
		$termargs     = array(
			'taxonomy'   => array( 'drucktechnik' ), // taxonomy name
			'field'      => 'term_id',
			'orderby'    => 'name',
			'order'      => 'ASC',
			'hide_empty' => true,
		...
		$term_list = '<div class="cat-filter spacer-2">
			<label for="name">' . __( 'Drucktechnik:', 'artifiche' ) . '</label>
		...
		while ( have_posts() ) :
			...
			. $posters .
			'</div></div>
			<input type="hidden" name="tax-readmore-name" id="tax-readmore-name" value="drucktechnik">
