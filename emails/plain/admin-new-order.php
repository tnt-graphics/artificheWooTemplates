...
foreach ( $items as $item ) {
	...
	echo esc_html( wp_strip_all_tags( wptexturize( __( 'Poster-Nummer: ','artifiche') .$poster_number ) ) );
	echo "\n";
	echo esc_html( wp_strip_all_tags( wptexturize(__( 'Poster-ID: ','artifiche') .$poster_id ) ) );
	echo "\n\n----\n\n";
}
echo "\n\n----------------------------------------\n\n";
