...
<main id="primary" class="site-main">
	...
	<div class="archive-description mobile-only">
		<div class="brief-txt">
			<?php $des = get_the_archive_description();
	...
	<?php
		...
		$termargs     = array(
			'taxonomy'   => array( 'marke' ), // taxonomy name
			'field'      => 'term_id',
			'orderby'    => 'name',
			'order'      => 'ASC',
			'hide_empty' => true,
		...
		$term_list = '<div class="cat-filter spacer-2">
			<label for="name">' . __( 'Marke:', 'artifiche' ) . '</label>
...
if ( $stock_status == 'outofstock' ) {
		...
		$k_flag = false;
			...
			. $posters .
			'</div></div>
			<input type="hidden" name="tax-readmore-name" id="tax-readmore-name" value="marke">
