...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_country', true ) ) : ?>
			<p class="form-row form-row-wide woo-custom-select" id="calc_shipping_country_field">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_state', true ) ) : ?>
			<p class="form-row form-row-wide woo-custom-select" id="calc_shipping_state_field">
				<?php
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button mt-4"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button></p>
