...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<tr class="cart-subtotal">
			...
			<td data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>"><span class="mob-tab"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></span><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
		...
		<tr class="order-total">
			...
			<span class="mob-tab"><?php esc_html_e( 'Total', 'woocommerce' ); ?></span>
